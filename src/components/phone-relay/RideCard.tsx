...
const S = {
  ...
  avatar: { width: 28, height: 28, borderRadius: '50%', background: 'rgba(110, 54, 238, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, flexShrink: 0, border: '1px solid rgba(110, 54, 238, 0.15)' },
  ...
  eta: { fontSize: 12, color: 'rgba(140, 80, 255, 0.95)', fontWeight: 600 as const },
};
