...
const S = {
  ...
  card: (isSelected: boolean): React.CSSProperties => ({
    ...
    background: isSelected ? 'rgba(110, 54, 238, 0.06)' : 'rgba(10, 15, 30, 0.85)',
    backdropFilter: 'blur(16px)', borderRadius: 12, padding: '12px 14px',
    border: isSelected ? '1px solid rgba(110, 54, 238, 0.3)' : '1px solid rgba(110, 54, 238, 0.06)',
    cursor: 'pointer', scrollSnapAlign: 'start' as const,
    transition: 'border-color 0.15s, background 0.15s, box-shadow 0.15s',
    display: 'flex', flexDirection: 'column' as const, gap: 8,
    boxShadow: isSelected ? '0 0 16px rgba(110, 54, 238, 0.06)' : 'none',
  }),
  cardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  cardTitle: { fontSize: 12, fontWeight: 600 as const, color: 'rgba(110, 54, 238, 0.8)', whiteSpace: 'nowrap' as const, overflow: 'hidden' as const, textOverflow: 'ellipsis' as const, flex: 1 },
  ...
  detailPanel: { width: '88vw', maxWidth: 400, maxHeight: '80vh', background: 'rgba(10, 15, 30, 0.96)', backdropFilter: 'blur(24px)', borderRadius: 16, padding: 20, display: 'flex', flexDirection: 'column' as const, gap: 12, boxShadow: '0 8px 32px rgba(0, 0, 0, 0.6), 0 0 24px rgba(110, 54, 238, 0.04)', border: '1px solid rgba(110, 54, 238, 0.1)', overflowY: 'auto' as const },
  ...
  closeBtn: { background: 'rgba(255, 255, 255, 0.06)', border: '1px solid rgba(110, 54, 238, 0.12)', color: 'rgba(255, 255, 255, 0.6)', borderRadius: 8, padding: '4px 10px', fontSize: 12, cursor: 'pointer', transition: 'background 0.15s' },
  detailBody: { fontSize: 13, lineHeight: 1.6, color: 'rgba(255, 255, 255, 0.75)', borderTop: '1px solid rgba(110, 54, 238, 0.06)', paddingTop: 12 },
  ...
  dot: (active: boolean): React.CSSProperties => ({ width: 5, height: 5, borderRadius: '50%', background: active ? 'rgba(110, 54, 238, 0.9)' : 'rgba(255, 255, 255, 0.15)', transition: 'background 0.2s', boxShadow: active ? '0 0 6px rgba(110, 54, 238, 0.3)' : 'none' }),
};
