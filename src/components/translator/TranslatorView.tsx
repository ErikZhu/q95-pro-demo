...
const S = {
  ...
  topBar: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', borderBottom: '1px solid rgba(110, 54, 238, 0.06)' },
  ...
  langSelect: { background: 'rgba(255, 255, 255, 0.04)', border: '1px solid rgba(110, 54, 238, 0.12)', borderRadius: 8, color: 'rgba(255, 255, 255, 0.92)', fontSize: 13, padding: '6px 10px', cursor: 'pointer', outline: 'none', minWidth: 90, transition: 'border-color 0.15s' },
  swapBtn: { width: 32, height: 32, borderRadius: '50%', background: 'rgba(110, 54, 238, 0.08)', border: '1px solid rgba(110, 54, 238, 0.2)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, color: 'rgba(110, 54, 238, 0.9)', transition: 'background 0.15s, border-color 0.15s' },
  inputModeBar: { display: 'flex', justifyContent: 'center', gap: 8, padding: '0 16px 10px' },
  modeBtn: { fontSize: 12, padding: '4px 14px', borderRadius: 14, border: '1px solid rgba(110, 54, 238, 0.1)', background: 'transparent', color: 'rgba(255, 255, 255, 0.5)', cursor: 'pointer', transition: 'all 0.15s' },
  modeBtnActive: { fontSize: 12, padding: '4px 14px', borderRadius: 14, border: '1px solid rgba(110, 54, 238, 0.4)', background: 'rgba(110, 54, 238, 0.08)', color: 'rgba(110, 54, 238, 0.95)', cursor: 'pointer' },
  resultsArea: { flex: 1, overflowY: 'auto' as const, padding: '8px 16px', display: 'flex', flexDirection: 'column' as const, gap: 10 },
  resultCard: { background: 'rgba(255, 255, 255, 0.03)', borderRadius: 10, padding: '10px 14px', border: '1px solid rgba(110, 54, 238, 0.06)' },
  ...
  translatingIndicator: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 16, fontSize: 14, color: 'rgba(110, 54, 238, 0.7)' },
  bottomBar: { padding: '12px 16px', borderTop: '1px solid rgba(110, 54, 238, 0.06)', display: 'flex', flexDirection: 'column' as const, gap: 8 },
  latestResult: { background: 'rgba(110, 54, 238, 0.04)', borderRadius: 10, padding: '12px 16px', border: '1px solid rgba(110, 54, 238, 0.1)' },
  latestLabel: { fontSize: 10, color: 'rgba(110, 54, 238, 0.5)', marginBottom: 4, textTransform: 'uppercase' as const, letterSpacing: 0.8, fontWeight: 600 },
