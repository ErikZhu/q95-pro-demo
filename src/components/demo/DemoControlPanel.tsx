...
const S = {
  overlay: (visible: boolean): React.CSSProperties => ({
    ...
    borderLeft: '1px solid rgba(100, 200, 255, 0.08)',
    transform: visible ? 'translateX(0)' : 'translateX(100%)',
    transition: 'transform 0.25s cubic-bezier(0.4, 0, 0.2, 1)',
    display: 'flex', flexDirection: 'column' as const, overflow: 'hidden',
  }),
  header: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 14px', borderBottom: '1px solid rgba(100, 200, 255, 0.06)', flexShrink: 0 } as React.CSSProperties,
  ...
  section: { background: 'rgba(255, 255, 255, 0.02)', borderRadius: 8, padding: '8px 10px', display: 'flex', flexDirection: 'column' as const, gap: 6, border: '1px solid rgba(100, 200, 255, 0.04)' } as React.CSSProperties,
  sectionLabel: { fontSize: 10, fontWeight: 700, color: 'rgba(100, 200, 255, 0.4)', textTransform: 'uppercase' as const, letterSpacing: 1.2, marginBottom: 2, display: 'flex', alignItems: 'center', gap: 6 } as React.CSSProperties,
  row: { display: 'flex', flexWrap: 'wrap' as const, gap: 4 } as React.CSSProperties,
  btn: (active: boolean): React.CSSProperties => ({
    padding: '5px 10px', fontSize: 11, borderRadius: 6,
    border: `1px solid ${active ? 'rgba(100, 200, 255, 0.3)' : 'rgba(100, 200, 255, 0.08)'}`,
    background: active ? 'rgba(100, 200, 255, 0.15)' : 'rgba(255, 255, 255, 0.03)',
    color: active ? 'rgba(100, 200, 255, 0.95)' : 'rgba(255, 255, 255, 0.75)',
  ...
  textInput: { flex: 1, padding: '5px 8px', fontSize: 11, borderRadius: 6, border: '1px solid rgba(100, 200, 255, 0.08)', background: 'rgba(255, 255, 255, 0.03)', color: 'rgba(255, 255, 255, 0.92)', outline: 'none', transition: 'border-color 0.15s' } as React.CSSProperties,
  trackArea: { width: '100%', height: 70, borderRadius: 8, border: '1px solid rgba(100, 200, 255, 0.08)', background: 'rgba(255, 255, 255, 0.02)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, color: 'rgba(255, 255, 255, 0.25)', cursor: 'crosshair', position: 'relative' as const, userSelect: 'none' as const } as React.CSSProperties,
  cursor: (x: number, y: number): React.CSSProperties => ({ position: 'absolute', left: `${x}%`, top: `${y}%`, width: 8, height: 8, borderRadius: '50%', background: 'rgba(100, 200, 255, 0.8)', boxShadow: '0 0 8px rgba(100, 200, 255, 0.4)', transform: 'translate(-50%, -50%)', transition: 'left 0.05s, top 0.05s', pointerEvents: 'none' as const }),
  footer: { padding: '8px 14px', borderTop: '1px solid rgba(100, 200, 255, 0.06)', fontSize: 10, color: 'rgba(255, 255, 255, 0.25)', textAlign: 'center' as const, flexShrink: 0 } as React.CSSProperties,
};
