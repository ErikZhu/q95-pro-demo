...
const S = {
  ...
  sidebar: { width: 140, borderRight: '1px solid rgba(100, 200, 255, 0.06)', display: 'flex', flexDirection: 'column' as const, padding: '8px 0', overflowY: 'auto' as const },
  ...
  catBtnActive: { background: 'rgba(100, 200, 255, 0.06)', color: 'rgba(100, 200, 255, 0.95)', borderLeft: '2px solid rgba(100, 200, 255, 0.7)' },
  ...
  row: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid rgba(100, 200, 255, 0.04)' },
  label: { fontSize: 13, color: 'rgba(255, 255, 255, 0.75)' },
  value: { fontSize: 13, color: 'rgba(100, 200, 255, 0.9)', fontFamily: "'SF Mono', 'Fira Code', monospace" },
  slider: { width: 120, accentColor: 'rgba(100, 200, 255, 0.8)' },
  ...
  toggleOn: { background: 'rgba(100, 200, 255, 0.2)', color: 'rgba(100, 200, 255, 0.95)' },
  toggleOff: { background: 'rgba(255, 255, 255, 0.06)', color: 'rgba(255, 255, 255, 0.35)' },
  deviceRow: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid rgba(100, 200, 255, 0.04)' },
  connBtn: { padding: '4px 12px', borderRadius: 6, border: '1px solid rgba(100, 200, 255, 0.2)', background: 'rgba(100, 200, 255, 0.06)', color: 'rgba(100, 200, 255, 0.9)', fontSize: 11, cursor: 'pointer', transition: 'background 0.15s' },
  ...
  feedback: { padding: '8px 12px', borderRadius: 8, background: 'rgba(80, 220, 160, 0.06)', border: '1px solid rgba(80, 220, 160, 0.2)', fontSize: 12, color: 'rgba(80, 220, 160, 0.9)' },
